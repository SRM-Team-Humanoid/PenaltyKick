...
path = os.path.dirname(os.getcwd()) + "/dash/src/dash/include/super.json"
pathback = os.path.dirname(os.getcwd()) + "/dash/src/dash/include/Backwalking.json"
...
if __name__ == "__main__":
	...
	raw_input("Proceed da?")
        ...
        rospy.Subscriber('detect',String,listener,queue_size=10)
        rospy.spin()
